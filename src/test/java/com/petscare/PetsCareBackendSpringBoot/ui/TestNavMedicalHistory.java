...
public class TestNavMedicalHistory {
    public static void main(String[] args) {
        ...
        try {
            ...
            wait.until(ExpectedConditions.urlContains("/medical-history"));

            System.out.println("PRUEBA EXITOSA. Módulo correctamente cargado");

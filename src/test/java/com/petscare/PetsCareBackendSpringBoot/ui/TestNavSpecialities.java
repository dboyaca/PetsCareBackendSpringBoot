...
public class TestNavSpecialities {
    public static void main(String[] args){
        ...
        try{
            ...
            wait.until(ExpectedConditions.urlContains("/specialities"));

            System.out.println("PRUEBA EXITOSA: Módulo de especialidades correctamente desplegado");
